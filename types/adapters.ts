...
export interface UtilsAdapters {
  ...
  debounce<F extends Callback>(fn: F, ms: number,): Wrapper<F>,
  throttle<F extends Callback>(fn: F, ms: number, count: number,): Wrapper<F>,
  scoped<E extends object>(entity: E, onDispose: (entity: E) => any): E & { [Symbol.dispose](): ReturnType<typeof onDispose> },
  count<F extends Callback>(fn: F): Wrapper<F>,
